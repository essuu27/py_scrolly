...
# Y_OFFSET(int), how far down the screen the text image midline should be
Y_OFFSET = 200

# SLICE_SIZE(int) is the dot-width  of text image 'slice' that is processed.
...
# == Global variables ==
# scrndrft(array) is an array that controls the drifting of the backdrop
scrndrft = [1, 0, 0, 0, 50]

# drift_time(int) sets how far the backdrop 'drifts' before changing direction
drift_time = 90

# scrollwid(int), start_angle(int), imghgt(int), declarations
scrollwid = 0
start_angle = 0
imghgt = 0
